...
// Variable to display the mad lib the paragraph tag.
...
const story = 
    `My friends and I started a secret club! 
        We meet every day by the <b>${adj1}</b> <b>${adj2}</b>. 
        Our club has some rules if you want to join, you have to wear a <b>${adj2}</b> <b>${clothing}</b> on  your <b>${bodyPart}</b>.
         You are not allowed to <b>${verb1}</b> during meetings, and you can eat <b>${food}</b>. 
